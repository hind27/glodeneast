            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s" src="/img/about-01.png" alt="">
                            <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s" src="/img/about-03.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s" src="/img/about-04.jpg" alt="">
                            <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s" src="/img/about-02.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title text-center mx-auto ">
                        ...
                        <h1 class="display-6">{{ __('Golden East is a leading fertilizer producer in Beni Suef, offering advanced solutions to enhance crop quality and increase productivity. With our diverse and effective products, we contribute to sustainable agriculture and a green future.')}}</h1>
                    </div>
