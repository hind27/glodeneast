                ...
                {{-- <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                     <p class="fs-4 text-white animated zoomIn">{{ __('Welcome to') }} <strong class="text-dark"> {{ __('Gloden East') }}</strong></p>
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn"> {{ __('Golden East for agriculture development') }}</h1>
                                    <a href="" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn"> {{ __('Explore More') }}</a>
                                </div>
                            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="section-title">
                        <p class="fs-5 fw-medium fst-italic text-primary"> {{ __('Featured Acticle')}}</p>
