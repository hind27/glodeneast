        ...
        <div class="container py-2">
            <div class="row g-5 {{ app()->getLocale() == 'ar' ? 'text-md-end' : 'text-md-start' }}  text-center">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary  {{ app()->getLocale() == 'ar' ? 'ms-3' : 'me-3' }}"></i>{{ __('Plot 89 - Industrial Zone - Beni Suef Governorate') }}</p>
                    <p class="mb-2" ><i class="fa fa-phone-alt text-primary  {{ app()->getLocale() == 'ar' ? 'ms-3' : 'me-3' }} "></i> <span dir="{{ app()->getLocale() == 'ar' ? 'ltr' : '' }}">+012 345 67890</span></p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary  {{ app()->getLocale() == 'ar' ? 'ms-3' : 'me-3' }}"></i>info@goldeneasteg.com</p>
                    <div class="d-flex justify-content-md-start justify-content-center pt-3">
                        ...
                        <a class="btn btn-square btn-primary rounded-circle ms-2" href="https://www.facebook.com/p/Golden-east-100071358889659/?_rdr"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="col-lg-4 col-md-6 {{ app()->getLocale() == 'ar' ? 'text-end' : 'text-start' }}">
                    ...
                    <a class="btn btn-link d-block {{ app()->getLocale() == 'ar' ? 'text-end  ' : 'text-start' }}" href="{{ route('about', ['locale' => app()->getLocale()]) }}">  {{ __('About Us') }}</a>
                    <a class="btn btn-link d-block {{ app()->getLocale() == 'ar' ? 'text-end' : 'text-start' }}" href="{{ route('contact', ['locale' => app()->getLocale()]) }}">  {{ __('Contact Us') }}</a>
